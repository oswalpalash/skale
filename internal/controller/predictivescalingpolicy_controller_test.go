...
func testPolicy() *skalev1alpha1.PredictiveScalingPolicy {
	return &skalev1alpha1.PredictiveScalingPolicy{
		...
		Spec: skalev1alpha1.PredictiveScalingPolicySpec{
			...
			ForecastContextWindow: metav1.Duration{Duration: 30 * time.Minute},
			ForecastContextStep:   metav1.Duration{Duration: 30 * time.Second},
			RecentContextWindow:   metav1.Duration{Duration: 30 * time.Minute},
